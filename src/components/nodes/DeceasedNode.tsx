  ...
  return (
    <div className={`relative ${selected ? 'ring-2 ring-blue-500' : ''}`}>
      <svg width="60" height="60" viewBox="0 0 60 60">
        {isCircle
          ? <circle cx="30" cy="30" r="28" fill={data.color ?? '#e5e7eb'} stroke="#374151" strokeWidth="2.5" />
          : <rect x="2" y="2" width="56" height="56" rx="2" fill={data.color ?? '#e5e7eb'} stroke="#374151" strokeWidth="2.5" />
        }
        <line x1="10" y1="10" x2="50" y2="50" stroke="#374151" strokeWidth="3" data-testid="deceased-x" />
        <line x1="50" y1="10" x2="10" y2="50" stroke="#374151" strokeWidth="3" />
      </svg>
